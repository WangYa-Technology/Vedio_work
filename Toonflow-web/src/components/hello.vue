    ...
    <div class="helloGuide">
      ...
      <template v-if="currentStep === 0">
        <div class="welcomePage">
          <div class="welcomeLogo" style="display: flex; align-items: center; justify-content: center; font-size: 80px; background: linear-gradient(135deg, #ff9a56 0%, #ff6b35 100%); border-radius: 24px; width: 120px; height: 120px; margin: 0 auto;">🍊</div>
