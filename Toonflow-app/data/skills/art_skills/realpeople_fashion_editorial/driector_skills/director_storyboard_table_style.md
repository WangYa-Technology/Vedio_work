...
description: 分镜表都市约束 — 定义真人时尚大片在分镜表中的光影氛围规范、光源角度、动作节奏、环境动态、运镜禁忌与转场禁忌。适用于任何叙事类型。
...
分镜表是导演将剧本转化为镜头语言的核心工具。以下仅提供真人时尚大片风格在分镜表层面的约束规范。
...
- **都市环境元素优先** — 环境动态应选用都市世界观内的元素：车灯流动、雨滴划窗、咖啡热气、手机屏幕亮灭、窗帘微动、电梯数字跳动，禁止出现与时尚建筑与都市景观不兼容的元素
...
- **肢体语言现代化** — 都市人物举止应符合时尚建筑与都市景观气质：自信的步态、随性的倚靠、不经意的小动作（拨头发、看手表、咬唇）

---

## 五、运镜禁忌

- **禁用快速运镜** — 甩镜、急推、手持晃动与真人时尚大片的气质冲突（除非是动作/追逐场景）
