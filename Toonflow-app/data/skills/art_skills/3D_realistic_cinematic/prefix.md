...
| 维度 | 定义 |
|---|---|
| **一级风格** | 写实电影级 3D 风格（3D Animation Rendering） |
| **二级风格** | PBR物理材质质感 · 电影级光影层次 |
| **情感基调** | 宏大克制 · 明快温暖 |
...
| E4 | 电影叙事向默认遵循「暖底 + 冷暖对比」：暖色铺底，冷色用于背景/阴影 |
...
| 参数 | 值 | 说明 |
|---|---|---|
| 整体色温 | 偏暖 4800-5200K（推荐） | 温暖电影叙事主基调 |
| 肤色色温 | 微暖 5000-5400K（推荐） | 暖橙但有生命感 |
| 对比度 | 中等（建议保持） | 明暗层次清晰，但不过分强烈 |
| 饱和度 | 中高 65-80%（建议区间） | 写实电影级 3D 风格高级色调 |
...
| 编号 | 规则 |
|---|---|
| R1 | 必须包含「写实电影级 3D 风格 + PBR物理材质质感」风格锚定词 |
| R2 | 必须声明「清晰轮廓线 + 高细节材质」 |
