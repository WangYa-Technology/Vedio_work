...
description: 写实电影级3D渲染约束 — 定义3D卡通渲染在色调体系、光影方案、质感方向、都市场景空间元素、乐器选择与环境音上的全局约束。适用于任何叙事类型。
metaData: director_skills
---

# 写实电影级3D渲染约束 · 3D卡通渲染 · 技法参考

---

## 一、色调体系与画面基调

- **色调基底** — 全片以暖橙（C1）、天空蓝（C3）、樱花粉（C5）为基底色，整体色温偏暖（4800-5200K），饱和度中高（65-80%），呈现明快 写实电影级 3D 风格的温暖电影叙事感
...
- **禁用色域** — 暗沉灰暗色系、过度饱和的脏色、与 写实电影级 3D 风格明快气质不匹配的色彩体系均不兼容
...
- **PBR物理材质纪实感** — 写实电影级 3D 风格的核心：轮廓线清晰、上色明快、柔和光影层次
- **高细节材质 + 柔和光影** — 这是画面质感的锚点。不是过度平滑，不是现代写实渲染，是 写实电影级 3D 风格特有的PBR物理材质质感
- **材质细节丰富** — 所有服化道的材质细节应可信：衣料的褶皱纹理、金属的卡通高光、食物的温暖光泽。禁止"过度写实"和"粗糙低模感"
- **PBR物理材质不等于真实体积** — 写实电影级 3D 风格强调PBR物理材质质感表达（清晰轮廓线、明快上色、柔和光影层次），通过光影与构图设计放大感染力，而非依赖过度复杂特效

---

## 四、都市场景空间元素

写实电影级 3D 风格都市世界观特有的场景元素及其视觉叙事功能：
...
写实电影级 3D 风格都市世界观下的声音元素约束：

### 乐器选择

- **钢琴** — 日常/温馨/回忆段落的核心乐器，最能表现 写实电影级 3D 风格的质感
- **吉他** — 轻松/浪漫/街头段落，扫弦的温柔感适合都市氛围
- **弦乐铺底** — 情感升华/离别段落，拉弦的细腻感适合情绪过渡
- **电子音效** — 年轻感/节奏感段落，适合写实电影世界场景
- 环境音是重要元素但不宜喧宾夺主
