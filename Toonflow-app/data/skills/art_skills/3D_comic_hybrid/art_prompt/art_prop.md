...
2. **质感极致** — 材质纹理必须清晰可辨（金属/玻璃/塑料/木/布），但漫画油墨与网点渲染适度简化
3. **年代一致** — 所有道具必须符合动作漫画都市世界观，禁止古代/未来元素
...
| 提示词 | 3D美漫混合渲染渲染都市{器物}，{材质}质感，纹理清晰 | — |
...
| 提示词 | 3D美漫混合渲染渲染都市{设备}，现代材质，屏幕发光效果 | — |
...
| 材质 | 渲染要求 | 提示词 |
|---|---|---|
| 金属 | 反光/高光/冷光泽（漫画油墨与网点处理）、划痕微可见 | 金属质感、漫画油墨与网点光泽、反光清晰 |
| 玻璃 | 透明度/折射/光晕（漫画油墨与网点简化） | 玻璃质感、透明度清晰 |
...
```
3D 美漫混合渲染，电影级打光，活力漫画油墨与网点质感，高细节材质，高能动作氛围，卡通都市风，高细节卡通材质，适度英雄化夸张比例，高对比撞色，8K 超高清，电影级构图，柔和光影层次，明快卡通渲染风格，强烈戏剧张力，道具设定图，
anime style, cel-shaded, 3D animation render,
{道具类型}，{材质描述}，{工艺/装饰描述}，{状态描述}，
纯道具静物展示，道具独立陈列，无人持有，无人佩戴，
同一画面四宫格（2×2）：左上正面图+右上侧面图+左下背面图+右下细节特写，
纯净中性灰背景，均匀柔光，无硬阴影，
材质纹理清晰，漫画油墨与网点渲染，{材质光泽描述}，现代卡通都市风格，
8K 超高清，电影级构图，
图中不要有任何文字，
...
| R1 | 必须指定「纯净中性灰背景」 |
| R2 | 必须明确道具材质与工艺 |
| R3 | 道具造型必须符合动作漫画都市世界观 |
| R4 | 必须包含3D美漫混合渲染渲染关键词（cel-shaded, 3D animation render, anime style） |
...
| X7 | 过度写实材质纹理、破坏漫画油墨与网点风格一致性 |
| X8 | 古代/未来元素、非动作漫画都市风格 |