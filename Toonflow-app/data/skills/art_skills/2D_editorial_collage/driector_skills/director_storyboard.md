...
description: 导演分镜提示词技法 · 现代拼贴插画风格
...
本 Skill 专用于**现代拼贴插画风格**风格的分镜提示词生成。
...
| 情绪输入 | 面容词 | 眼神词 | 微表情补充 |
|----------|--------|--------|-----------|
| 心动 / 欣喜 | 剪纸边缘，橙色色块 | 圆形眼睛，眼神明亮 | 简单笑脸，拼贴化 |
| 悲伤 / 失落 | 剪纸边缘，冷色色调 | 椭圆形眼睛，眼神柔和 | 嘴角下弯，拼贴化 |
| 惊讶 / 好奇 | 圆形眼睛，放大表情 | 眼神集中，目光好奇 | 嘴巴O型，拼贴化 |
| 温柔 / 深情 | 柔和线条，暖色色调 | 眼神专注，目光柔和 | 嘴角上弯，拼贴化 |
| 坚定 / 勇敢 | 直线线条，冷色色调 | 眼神坚定，目光集中 | 表情明确，拼贴化 |
| 害羞 / 羞涩 | 粉色色块，圆润线条 | 眼睛向下，不敢直视 | 脸颊红晕，拼贴化 |
| 温暖 / 感动 | 暖色线条，柔和表情 | 眼神温暖，目光柔和 | 嘴角上扬，拼贴化 |
| 孤独 / 怀念 | 冷色线条，简洁表情 | 眼神放空，若有所思 | 表情平静，拼贴化 |
| 快乐 / 雀跃 | 圆形线条，明亮表情 | 眼睛弯月，表情生动 | 动作轻快，拼贴化 |
| 紧张 / 不安 | 线条变细，眉头符号 | 眼睛变小，目光不确定 | 手位紧张，拼贴化 |
...
| 场景类型 | 必加约束词 |
|----------|-----------|
| 拼贴人物 | 几何造型，剪纸边缘，纸张层叠与丝网印刷纹理，印刷色块色块填充 |
| 拼贴场景 | 印刷色块背景，几何形状，简单结构，无纹理无细节 |
| 办公空间 | 简洁家具，几何形状，冷色调，现代设计感 |
| 居家空间 | 简约家具，暖色调，几何线条，温馨氛围 |
| 城市景观 | 几何建筑剪影、纸张层叠与印刷色块，现代编辑设计感 |
| 自然环境 | 几何树木，印刷色块草地，简单形状，拼贴化自然 |
| 交通场景 | 简化车辆，几何形状，冷色调，现代交通感 |
| 室内空间 | 简洁隔断，印刷色块墙面，几何门窗，现代简约 |
...
2D拼贴风，Editorial Collage，纸张层叠与丝网印刷纹理，印刷色块色块，剪纸边缘

**色块质感（所有输出必选）：**

印刷色块填充，无纹理无渐变，几何造型，拼贴化设计
...
简约现代氛围，拼贴设计美学，清晰情感表达，现代感视觉

**画质锁定词（所有输出必须包含，置于风格收尾之后）：**

模式A（中文）——默认：
高清画质，线条清晰，色彩纯净，画面无杂色无噪点，纸张层叠与丝网印刷纹理

模式A（中文）——画内文字场景（画面描述中含招牌/标识等道具文字时）：
高清画质，线条清晰，色彩纯净，画面无杂色无噪点，纸张层叠与丝网印刷纹理，招牌/标识等道具文字清晰可读
...
|------|---------|------|-------------|------|------|------|---------|------|----------|
| 1 | 拼贴风格两人相遇，橙色与蓝色色块对比，简洁背景 | 城市 | 角色A/B | 5s | 中景 | 静止 | 对视微笑，剪纸边缘 | 心动 / 温暖 | 暖色对比 + 留白 |

### 示例输出A（模式A · Seedream）

[Prompt]
2D拼贴风，Editorial Collage，纸张层叠与丝网印刷纹理，印刷色块色块，剪纸边缘，中景构图，两个拼贴角色半身入镜，印刷色块填充，无纹理无渐变，几何造型，拼贴化设计，清晰轮廓线，线条均匀一致，无断线无粗糙边缘，色彩饱和适中，色块对比清晰，无复杂光影层次，拼贴风格两人相遇，橙色与蓝色色块对比，简洁背景，对视微笑，线条简洁，眼神明亮，暖色对比，留白较多，简约现代氛围，拼贴设计美学，清晰情感表达，现代感视觉，高清画质，线条清晰，色彩纯净，画面无杂色无噪点，纸张层叠与丝网印刷纹理。
