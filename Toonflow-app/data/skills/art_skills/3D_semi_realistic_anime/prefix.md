...
| 维度 | 定义 |
|---|---|
| **一级风格** | 半写实 3D 漫（3D Animation Rendering） |
| **二级风格** | 半写实肌理质感 · 电影级光影层次 |
| **情感基调** | 成熟浪漫 · 明快温暖 |
...
| 参数 | 值 | 说明 |
|---|---|---|
| 整体色温 | 偏暖 4800-5200K（推荐） | 细腻克制主基调 |
| 肤色色温 | 微暖 5000-5400K（推荐） | 暖橙但有生命感 |
| 对比度 | 中等（建议保持） | 明暗层次清晰，但不过分强烈 |
| 饱和度 | 中高 65-80%（建议区间） | 半写实 3D 漫高级色调 |
...
| 编号 | 规则 |
|---|---|
| R1 | 必须包含「半写实 3D 漫 + 半写实肌理质感」风格锚定词 |
| R2 | 必须声明「清晰轮廓线 + 高细节材质」 |
| R3 | 面部必须使用「写实材质与自然化动漫比例结合 + 柔和光影」 |
