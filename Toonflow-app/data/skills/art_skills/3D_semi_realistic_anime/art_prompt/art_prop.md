...
2. **质感极致** — 材质纹理必须清晰可辨（金属/玻璃/塑料/木/布），但半写实肌理渲染适度简化
3. **年代一致** — 所有道具必须符合电影化幻想世界世界观，禁止古代/未来元素
...
| 材质 | 渲染要求 | 提示词 |
|---|---|---|
| 金属 | 反光/高光/冷光泽（半写实肌理处理）、划痕微可见 | 金属质感、半写实肌理光泽、反光清晰 |
| 玻璃 | 透明度/折射/光晕（半写实肌理简化） | 玻璃质感、透明度清晰 |
...
```
半写实 3D 漫，电影级打光，活力半写实肌理质感，高细节材质，成熟克制氛围，卡通都市风，高细节卡通材质，适度自然化动漫比例，电影化冷暖配色，8K 超高清，电影级构图，柔和光影层次，明快卡通渲染风格，细腻克制，道具设定图，
anime style, cel-shaded, 3D animation render,
{道具类型}，{材质描述}，{工艺/装饰描述}，{状态描述}，
纯道具静物展示，道具独立陈列，无人持有，无人佩戴，
同一画面四宫格（2×2）：左上正面图+右上侧面图+左下背面图+右下细节特写，
纯净中性灰背景，均匀柔光，无硬阴影，
材质纹理清晰，半写实肌理渲染，{材质光泽描述}，现代卡通都市风格，
8K 超高清，电影级构图，
图中不要有任何文字，
...
| R1 | 必须指定「纯净中性灰背景」 |
| R2 | 必须明确道具材质与工艺 |
| R3 | 道具造型必须符合电影化幻想世界世界观 |
| R4 | 必须包含半写实3D漫渲染关键词（cel-shaded, 3D animation render, anime style） |
...
| X7 | 过度写实材质纹理、破坏半写实肌理风格一致性 |
| X8 | 古代/未来元素、非电影化幻想世界风格 |