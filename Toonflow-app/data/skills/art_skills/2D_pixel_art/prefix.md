...
|---|---|
| **一级风格** | 复古像素艺术风格 |
| **二级风格** | 几何造型 · 有限色色块 · 阶梯明暗与可控抖色 |
| **情感基调** | 简约现代 · 明快清新 |
| **质感锚词** | 像素轮廓、有限色填充、色块对比 |
...
| L3 例外机制 | 低 | 浪漫/高潮/特殊场景可临时突破局部色彩，但需保留整体像素逻辑 |
...
| 编号 | 规则 |
|---|---|
| R1 | 必须包含「2D像素风 + Pixel Art」风格锚定词 |
| R2 | 必须声明「阶梯明暗与可控抖色 + 有限色色块」 |
| R3 | 面部必须使用「几何造型 + 像素轮廓」 |
| R4 | 轮廓线必须使用「清晰线条 + 均匀一致」 |
| R5 | 色彩必须声明「有限色填充 + 色块对比清晰」 |
