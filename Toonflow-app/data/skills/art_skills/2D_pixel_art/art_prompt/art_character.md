...
| 项目 | 约束 | 提示词 |
|---|---|---|
| 肤色 | 单色填充、无渐变 | 单色皮肤、像素肤色、solid skin color |
| 光泽 | 无高光、无反光 | 无光泽、哑光像素、matte finish |
| 质感 | 色块填充、无纹理 | 色块填充、平面质感、no texture |
| 露肤 | 面部/颈部/锁骨/手部 | 色块肤色、像素肤表 |
...
| 项目 | 约束 | 提示词 |
|---|---|---|
| 发色 | 纯黑单色、无渐变 | 黑色头发、有限色发色 |
| 发长 | 及腰或更长 | 长发、及腰长发 |
| 发质 | 线条勾勒、无发丝细节 | 线条发型、像素发色、no hair strands |
...
- 服装风格须与像素矢量插画美学一致（有限色色块、无渐变、无光影）
- 颜色低饱和有限色填充，无复杂花纹/装饰，便于后续衍生叠加
- 四视图服装款式完全一致
