...
| 风格 | 适用场景 | 核心提示词 |
|---|---|---|
| 清雅素妆 | 日常、初遇、闺中 | 像素妆容、淡雅色块、简约化妆 |
| 冷艳霜妆 | 正式、对峙、权力 | 像素冷妆、像素轮廓、色块妆容 |
| 柔媚桃妆 | 甜宠、暧昧、心动 | 像素桃妆、粉色调色、色块表达 |
| 病弱梨妆 | 受伤、虚弱 | 像素病妆、苍白肤色、淡色唇 |
| 华贵凤妆 | 大婚、盛装 | 像素浓妆、色块浓郁、精致线条 |

### 通用底肤（所有妆容共享）

| 项目 | 约束 | 提示词 |
|---|---|---|
| 质感 | 单色填充、无渐变 | 单色皮肤、像素肌肤、solid skin |
| 白度 | 浅色单色、均匀 | 浅肤色、单色肤色 |
...
| 项目 | 约束 | 提示词 |
|---|---|---|
| 眉部 | 线条勾勒、单色填充 | 线条眉、像素眉形 |
| 眼部 | 简化色块、无瞳孔细节 | 像素眼、色块眼部 |
| 面颊 | 极淡色块、不可明显堆色 | 极淡腮红、色块提气 |
| 唇部 | 单色润色、保持克制 | 单色唇、像素唇 |
| 整体 | 看得出有妆造，但色块非常轻 | 基础像素妆、伪素颜像素 |
...
| 造型 | 描述 | 适用 | 提示词 |
|---|---|---|---|
| 半挽云髻 | 发顶挽髻+后方垂发 | 日常、出行 | 像素云髻、简约发髻 |
| 飞仙髻 | 高髻飞挑、像素轮廓 | 仙境、亮相 | 像素飞髻、线条高髻 |
| 堕马髻 | 侧偏低髻、慵懒线条 | 私密、暧昧 | 像素堕髻、线条侧髻 |
| 双环髻 | 双髻对称、少女线条 | 年轻角色 | 像素双髻、简单双环 |
| 全散发 | 长发全散、配简单发饰 | 受伤、落魄 | 像素散发、线条长发 |
| 束发马尾 | 高束干练、像素轮廓 | 习武、行动 | 像素马尾、线条束发 |

### 女性发饰

| 项目 | 约束 | 提示词 |
|---|---|---|
| 风格 | 像素化装饰、几何形 | 像素发饰、几何装饰 |
| 材质 | 线条勾勒、单色填充 | 线条饰品、色块发饰 |
| 工艺 | 像素轮廓、极简工艺 | 像素轮廓、像素工艺 |
...
|---|---|---|
| 束发半冠 | 日常、文人 | 像素束发、线条冠 |
| 全冠高束 | 正式、朝堂 | 像素全冠、线条束发 |
| 散发披肩 | 私密、受伤 | 像素散发、线条长发 |
| 战束马尾 | 战斗、习武 | 像素战发、线条马尾 |
...
| 风格 | 款式 | 适用 | 提示词 |
|---|---|---|---|
| 简约飘逸装 | 多层大袖衫、像素线条 | 日常、仙境 | 像素大袖、线条衣衫 |
| 端庄礼服 | 曲裾深衣/襦裙、几何线条 | 朝堂、宴会 | 像素曲裾、简约深衣 |
| 轻便常服 | 窄袖襦裙/短衫、像素轮廓 | 行动、习武 | 像素窄袖、简洁短衫 |
| 寝衣 | 薄纱内衫、素色像素 | 室内、夜间 | 像素寝衣、素色衣物 |
| 大婚嫁衣 | 凤冠霞帔、层叠色块 | 婚礼 | 像素嫁衣、多层色块 |

### 女性服饰通用约束

| 项目 | 约束 | 提示词 |
|---|---|---|
| 主色 | 白色/月白/银灰为默认 | 白色像素衣服、简约衣物 |
| 材质 | 有限色色块、无纹理 | 有限色衣物、无纹理 |
| 质感 | 线条必须清晰 | 线条清晰、色块分明 |
| 肩部 | 肩饰/披帛/云肩线条 | 线条肩饰、像素云肩 |
| 层次 | 多层叠穿、色块分明 | 多层叠穿、像素层次 |

### 男性服饰矩阵

| 风格 | 适用 | 提示词 |
|---|---|---|
| 文人雅装 | 日常、书房 | 像素长衫、简约衣衫 |
| 武将劲装 | 战斗、练武 | 像素劲装、简洁战服 |
| 玄衣大氅 | 出场、夜行 | 像素大氅、线条披风 |
| 常服便装 | 休闲、私密 | 像素常服、简约便装 |
| 礼服朝服 | 朝堂、典礼 | 像素朝服、简约礼袍 |
...
| 类型 | 约束 | 提示词 |
|---|---|---|
| 头饰 | 像素化、几何形 | 像素头饰、几何发饰 |
| 耳饰 | 线条流苏/玉珰 | 线条耳环、像素珰 |
| 项饰 | 线条璎珞/项圈 | 线条璎珞、像素项圈 |
| 腰饰 | 线条宫绦/玉佩 | 线条宫绦、像素玉佩 |
| 手饰 | 线条玉镯/臂钏 | 线条手镯、像素钏 |
...
|---|---|---|
| 发冠 | 像素冠、像素轮廓 | 像素冠、线条冠 |
| 腰封 | 线条腰封、像素色块 | 线条腰封、像素带 |
| 玉佩 | 像素玉佩、简洁造型 | 像素玉佩、线条佩 |
| 兵器 | 佩剑/扇/笛（可选） | 像素剑、线条扇 |
...
| 场景 | 妆容 | 发型 | 服饰 | 配饰 |
|---|---|---|---|---|
| 日常闺中 | 清雅素妆 | 半挽云髻 | 简约飘逸装 | 像素中等 |
| 初次相遇 | 清雅素妆 | 半挽/飞仙 | 简约飘逸装 | 像素中偏多 |
| 甜宠互动 | 柔媚桃妆 | 半挽/堕马 | 简约/轻便 | 像素中等 |
| 正式亮相 | 冷艳霜妆 | 飞仙髻 | 端庄礼服 | 像素极繁 |
| 夜间密谈 | 清雅/桃妆 | 全散/堕马 | 寝衣 | 像素极简 |
| 受伤落魄 | 病弱梨妆 | 全散（乱） | 破损常服 | 像素极简/无 |
| 大婚典礼 | 华贵凤妆 | 飞仙髻 | 嫁衣 | 像素极繁 |
| 习武行动 | 素妆（极淡） | 束发马尾 | 轻便常服 | 像素简 |
...
> | 服饰 | 所有服饰必须转化为像素色块表达；纹样极度简化；多层叠穿保留轮廓感即可 |
> | 配饰繁度 | 像素化处理优先；正式→像素极繁（简化为色块头饰+腰饰轮廓）；日常→像素中等 |
...
保持基础形象轮廓不变，{整体气质}，
【L1·妆容】根据用户线索决策：{基础妆/轻妆/正式妆}；使用 {妆容风格}，单色皮肤，像素肤色，{眉妆}，{眼妆}，{唇妆}，
...
| R14 | **上妆强度受控**——即使上妆也需克制，不得出现现代像素浓妆/夸张彩妆效果 |
