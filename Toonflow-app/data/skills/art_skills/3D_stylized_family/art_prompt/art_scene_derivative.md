...
5. **手绘材质为锚** — 所有变体必须保持风格化家庭动画3D渲染+手绘材质风格，拒绝写实摄影/CG 动画感；保持镜头特征与光影一致性
6. **都市氛围统一** — 所有变体需保持家庭冒险世界风格、暖色调配色
...
| 时段 | 视觉特征 | 提示词 |
|---|---|---|
| 清晨 | 薄雾柔光、色调偏冷暖交织（手绘材质化） | 晨光微熹、清晨薄雾 |
| 正午 | 明亮、阴影短、色彩鲜明（手绘材质化） | 正午阳光、光线明亮 |
| 黄昏 | 金色色调、长影、天空渐变（手绘材质化） | 暮色金辉、golden hour |
| 夜间（月光） | 冷蓝色调、幽静清冷（手绘材质化） | 月光清辉、moonlight |
| 夜间（灯火） | 暖黄点缀、明暗对比（手绘材质化） | 灯火阑珊、烛光点点 |

### 时段衍生规范

| 从基准时段衍生 | 保持不变 | 变化项 |
|---|---|---|
| 日间 → 黄昏 | 建筑/布局/材质 | 天空色调暖化、影子拉长（手绘材质化） |
| 日间 → 夜间 | 建筑/布局/材质 | 整体变暗、增加灯火/月色氛围（手绘材质化） |
| 室内日间 → 室内夜间 | 空间结构、家具 | 整体色调暖化、增加烛火/灯笼元素（手绘材质化） |
...
| 天候 | 视觉特征 | 提示词 |
|---|---|---|
| 晴天 | 明亮、阴影清晰（手绘材质化） | 晴空万里、阳光明媚 |
| 阴天 | 光线均匀、无硬影（手绘材质化） | 阴天柔光、overcast |
| 薄雾 | 能见度降低、空气朦胧（手绘材质化） | 薄雾弥漫、雾气缭绕 |
| 细雨 | 水珠、湿润反光、雨丝（手绘材质化） | 细雨如丝、雨幕轻纱 |
| 飞雪 | 白色覆盖、雪花飘落（手绘材质化） | 飞雪纷纷、银装素裹 |

### 天候衍生规范

| 从基准天候衍生 | 保持不变 | 变化项 |
|---|---|---|
| 晴 → 薄雾 | 建筑/布局 | 增加雾气层、远景模糊、饱和度降低（手绘材质化） |
| 晴 → 细雨 | 建筑/布局 | 增加雨丝、地面反光、色调偏冷（手绘材质化） |
| 晴 → 飞雪 | 建筑/布局 | 增加积雪、雪花、色调偏白（手绘材质化） |
| 植被需随天候逻辑适配 | — | 雨中花瓣湿润、雪中枯枝挂霜（手绘材质化） |
...
| 项目 | 约束 |
|---|---|
| 参考一致性 | 建筑结构/布局/材质/色调/光线/季节/天候必须与参考图一致（手绘材质化处理） |
| 视点 | 同一场景中心点，仅角度切换；视线高度可随角度调整 |
| 光照逻辑 | 参考图光源方向不变，角度切换后光影投射方向需同步重算（手绘材质化处理） |
| 布局 | 单画面（非拼图、非多视图、非分屏） |
| 人物 | **严禁出现任何人物、人影、人体轮廓** |
...
## 六、提示词模板
```
风格化家庭动画 3D，电影级打光，活力手绘材质质感，高细节材质，愉悦治愈氛围，卡通都市风，高细节卡通材质，适度卡通比例，暖色调配色，8K 超高清，电影级构图，柔和光影层次，明快卡通渲染风格，温馨治愈，衍生场景图，基于参考图，
...
材质自然使用痕迹，生活感磨损，布料自然垂褶（手绘材质化），
自然光漫射，体积光，手绘材质光效，手绘材质投影，
空气透视，纹理清晰，手绘材质化处理，
单画面构图，与参考图保持建筑结构/材质/色调/光线一致，仅按目标角度切换视点，
画面中无任何人物，
手绘材质渲染风格，柔和光影，适度卡通比例，高细节卡通材质，
暖色调配色，黄昏霞光氛围，愉悦治愈氛围，
8K 超高清，电影级构图，
图中不要有任何文字
```
...
|---|---|
| R1 | 场景空间结构在所有变体中保持一致 |
| R2 | 时段变体必须调整天空色调与氛围（手绘材质化） |
| R3 | 天候变体必须适配植被/材质表面（手绘材质化） |
| R4 | 衍生图必须为「单画面」，不得拼接多视图/网格/分屏 |
| R5 | 衍生图必须与参考图保持建筑结构/材质/色调/光线一致，仅按指定角度切换视点 |
| R6 | 场景图中**严禁出现任何人物** |
| R7 | 根据用户提供的信息自行判断变化维度（角度/景别/时段/天候），未提及维度留空省略 |
| R8 | 必须包含风格化家庭动画3D渲染关键词（cel-shaded, 3D animation render, anime style） |
| R9 | 必须包含镜头光学特征（shallow depth of field / lens vignette / bokeh 至少一项，手绘材质化处理） |
| R10 | 材质必须带有自然磨损/岁月痕迹，禁止全新无瑕的"CG 感"，但手绘材质化呈现 |
| R11 | 必须保持手绘材质渲染风格一致性，不得混搭写实元素 |
...
|---|---|
| X1 | 变体间建筑结构/布局不一致 |
| X2 | 天候与季节矛盾（夏天飞雪等，手绘材质化限度内） |
| X3 | 变体间材质/风格突变 |
| X4 | 出现任何人物、人影、人体剪影或人体轮廓 |
| X5 | 画面被拼接成多视图/网格/分屏布局 |
| X6 | 3D 渲染/CG 动画/卡通/游戏引擎质感（禁用 3D render、CGI、Unreal Engine、Unity 等词），但需明确手绘材质动画渲染 |
| X7 | 材质过于干净完美、无任何使用痕迹与岁月感（避免"塑料感"），需手绘材质化处理 |
| X8 | 光照过于均匀平坦、无景深虚化、无镜头光学特征 |
| X9 | 使用写实摄影术语（如real photography, photorealistic, RAW photo等） |
| X10 | 古代/未来元素、非家庭冒险世界风格 |
